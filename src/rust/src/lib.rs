...
mod tests {
    ...
    async fn test_candle() -> anyhow::Result<()> {
        ...
        for prompt_index in 0.. {
            ...
            let prompt_tokens = if prompt_tokens.len() + to_sample > llama_model::MAX_SEQ_LEN - 10 {
                let to_remove = prompt_tokens.len() + to_sample + 10 - llama_model::MAX_SEQ_LEN;
